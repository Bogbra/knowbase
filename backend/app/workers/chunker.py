...
def split_text_with_metadata(
    ...
    for para_text, chapter in paragraphs:
        ...
        elif chapter and chapter != current_ch:
            # New section heading — flush immediately so each chunk belongs
            # to exactly one chapter (avoids chapter label being overwritten
            # when multiple short sections fit within chunk_size).
